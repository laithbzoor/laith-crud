  ...
  return (
    <React.Fragment key={user._id}>
      <tr>
        ...
        <td>{user.email}</td>
        <td>{user.password}</td>
        <td onClick={() => deleteUser(user._id)} className='btn btn-danger'><Link>Delete</Link></td>
        <td className='btn btn-warning'><Link to={`/user/${user._id}`}>Details</Link></td>
        <td className='btn btn-success'><Link to={`/user/edit/${user._id}`}>edit</Link></td>
